    ...
    <div class="cimb-auth-right">
        ...
        <div class="cimb-auth-form-card">
            <div class="cimb-auth-form-header">
                <h1 class="cimb-auth-form-title">Create a new account</h1>
                <p class="cimb-auth-form-desc">Fill in the details below to sign up</p>
            </div>
            ...
            <form action="/register" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nomor_rekening" name="nomor_rekening" placeholder="13 digit nomor rekening" value="{{ old('nomor_rekening') }}" maxlength="13" required>
                    @error('nomor_rekening') <p class="field-error">{{ $message }}</p> @enderror
                </div>
